!function($, wysi) {
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<h4>Upload your image</h4>" +
				  "<form name='temp_photo' id='imageUploadForm' enctype='multipart/form-data' action='/admin/media/uploadTemp' method='post'>" +
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
				...
				var formImageUploaded = $('#form-imageUploaded');
						...
						success:function(image){
							if(image == "error") {
								...
								if(image == "failed") {
									...
									formImageUploaded.append("<input type='hidden' name='formImageUploaded[]' value='" + image["path"] + "' />");
